...
/*
 * Usage i.e: node extractLookupTables.js
 * */

const extractLookupTables = () => {
  let syncPairNames = {
    de: {},
    en: {},
    es: {},
  ...
  let lookupByPokemonName = {};
  let lookupByTrainerId = {};
  let lookupBySyncPairName = {};
  ...
  trainerDB.entries.forEach((entry) => {
    ...
    if (
      ...
      // 10008000001, // Erika & Tangela
      // 10062000001, // Karen & Umbreon
      trainerId.toString() !== '10035000000' &&
      trainerId.toString() !== '10148000000' &&
      trainerId.toString() !== '10129000000' &&
      trainerId.toString() !== '10008000000' &&
      trainerId.toString() !== '10062000000'
    ) {
    ...
    if (trainerId === '10035000000') {
      thirdEvolvedFormMonsterId = '20035000001'; // Lt. Surge & Electrode
    }
    ...
    languages.forEach((language) => {
      ...
      // }
      //   let lookupEntry = `${pokemonEnglishName.toLowerCase()}: {pokemonName: ${pokemonEnglishName}, syncPairEnglishName: ${syncPairEnglishName}, trainerBaseId: ${trainerBaseId.toString()}, trainerId: ${trainerId.toString()}, monsterBaseId: ${monsterBaseId.toString()}, monsterId: ${monsterId.toString()} },`;

      if (language === 'en') {
        if (
          trainerEnglishName !== 'Lear' &&
          trainerEnglishName !== 'Rachel' &&
          trainerEnglishName !== 'Sawyer' &&
          trainerEnglishName !== 'Youngster' &&
          (trainerBaseId.toString() !== '10700000' ||
            trainerId.toString().slice(-1) !== '6')
        ) {
          if (lookupByTrainerId.hasOwnProperty(trainerId)) {
            console.log(
              `${trainerId} already exists in lookupByTrainerId. Sync pair name is ${syncPairEnglishName}`
            );
          }
          lookupByTrainerId[trainerId] = {
            pokemonEnglishName: pokemonEnglishName,
            syncPairEnglishName: syncPairEnglishName,
            trainerBaseId: trainerBaseId.toString(),
        ...
        if (
          ...
          if (
            trainerId.toString() === '10051000000' || // Lycanroc (Olivia)
            trainerId.toString() === '10247000000' || // Charizard (Leon)
            trainerId.toString() === '10148000001' // Morty & Mismagius
          ) {
            lookupByPokemonName[
              `${trainerEnglishName}_${pokemonEnglishName}`.toLowerCase()
            ] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
            ...
            trainerId.toString() === '10021010000' // new Blastoise
          ) {
            lookupByPokemonName['blastoise_new'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupByPokemonName[pokemonEnglishName.toLowerCase()] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupByPokemonName['lt_surge_raichu'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupByPokemonName['lt.surge_raichu'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            trainerId.toString() === '10035000000' // Lt. Surge & Electrode
          ) {
            lookupByPokemonName['lt.surge_electrode'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            trainerId.toString() === '10010000000' // Crasher Wake & Floatzel
          ) {
            lookupByPokemonName['crasherwake_floatzel'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            trainerId.toString() === '10137000000' // Professor Oak & Mew
          ) {
            lookupByPokemonName['professoroak_mew'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            trainerId.toString() === '10136000000' // Professor Sycamore & Xerneas
          ) {
            lookupByPokemonName['professorsycamore_xerneas'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            trainerId.toString() === '10094000000' // Drake & Salamence
          ) {
            lookupByPokemonName[
              `${trainerEnglishName}_${pokemonEnglishName}`.toLowerCase()
            ] = {
            ...
            if (
              lookupByPokemonName.hasOwnProperty(
                pokemonEnglishName.toLowerCase()
              )
            ) {
              console.log(
                `${trainerId} already exists in lookupByPokemonName. Sync pair name is ${syncPairEnglishName}`
              );
            }
            lookupByPokemonName[pokemonEnglishName.toLowerCase()] = {
              pokemonEnglishName: pokemonEnglishName,
        ...
        if (
          ...
          if (
            ...
            lookupBySyncPairName['lt_surge_raichu'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupBySyncPairName['lt.surge_raichu'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupBySyncPairName['lt.surge_electrode'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupBySyncPairName['crasherwake_floatzel'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupBySyncPairName['professoroak_mew'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            lookupBySyncPairName['professorsycamore_xerneas'] = {
              pokemonEnglishName: pokemonEnglishName,
              syncPairEnglishName: syncPairEnglishName,
              trainerBaseId: trainerBaseId.toString(),
              trainerId: trainerId.toString(),
            ...
            if (
              lookupBySyncPairName.hasOwnProperty(
                pokemonEnglishName.toLowerCase()
              )
            ) {
              console.log(
                `${trainerId} already exists in lookupBySyncPairName. Sync pair name is ${syncPairEnglishName}`
              );
            }
            lookupBySyncPairName[
              `${trainerEnglishName}_${pokemonEnglishName}`.toLowerCase()
  ...
  fs.writeFile(
    `${__dirname}/../../src/data/lookupTables.js`,
    `export const lookupByTrainerId =` +
      JSON.stringify(lookupByTrainerId) +
      `; export const lookupByPokemonName=` +
      JSON.stringify(lookupByPokemonName) +
      `; export const lookupBySyncPairName=` +
      JSON.stringify(lookupBySyncPairName),
    (err) => {
      if (err) throw err;
