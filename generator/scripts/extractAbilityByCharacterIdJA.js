...
const abilityDescriptionDB = require('../rawdata/ja/ability_description_ja.lsd.json');
const moveDB = require('../rawdata/Move.json');
const moveNameDB = require('../rawdata/ja/move_name_ja.lsd.json');
const moveDescriptionDB = require('../rawdata/ja/move_description_ja.lsd.json');
const passiveAbilityDescriptionDB = require('../rawdata/ja/passive_skill_name_ja.lsd.json');
const passiveSkillDescriptionDB = require('../rawdata/ja/passive_skill_description_ja.lsd.json');
const triangularCoordsToCollumns = require('../utils/triangularCoordsToCollumns');

/*
 * Usage i.e: node extractAbilityByCharacterIdJA.js --characterId=18000000000 --filename=pikachu
 * */
...
const extractAbilityByCharacterId = () => {
  ...
  if (args.filename) {
    fs.writeFile(
      `${__dirname}/../../src/data/grids/ja/${args.filename}.json`,
