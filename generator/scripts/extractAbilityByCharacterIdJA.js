...
const abilityDescriptionDB = require('../rawdata/ja/AbilityDescription.json');
const moveDB = require('../rawdata/Move.json');
const moveNameDB = require('../rawdata/ja/MoveName.json');
const moveDescriptionDB = require('../rawdata/ja/MoveDescription.json');
const passiveAbilityDescriptionDB = require('../rawdata/ja/PassiveSkillName.json');
const passiveSkillDescriptionDB = require('../rawdata/ja/PassiveSkillDescription.json');
