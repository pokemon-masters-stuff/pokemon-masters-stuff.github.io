...
const abilityDescriptionDB = require('../rawdata/en/ability_description_en.lsd.json');
const moveDB = require('../rawdata/Move.json');
const moveNameDB = require('../rawdata/en/move_name_en.lsd.json');
const moveDescriptionDB = require('../rawdata/en/move_description_en.lsd.json');
const passiveAbilityDescriptionDB = require('../rawdata/en/passive_skill_name_en.lsd.json');
const passiveSkillDescriptionDB = require('../rawdata/en/passive_skill_description_en.lsd.json');
const triangularCoordsToCollumns = require('../utils/triangularCoordsToCollumns');

/*
 * Usage i.e: node extractAbilityByCharacterIdEN.js --characterId=18000000000 --filename=pikachu
 * */
