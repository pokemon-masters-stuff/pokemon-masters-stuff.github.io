...
const abilityDescriptionDB = require('../rawdata/es/ability_description_es.lsd.json');
const moveDB = require('../rawdata/Move.json');
const moveNameDB = require('../rawdata/es/move_name_es.lsd.json');
const moveDescriptionDB = require('../rawdata/es/move_description_es.lsd.json');
const passiveAbilityDescriptionDB = require('../rawdata/es/passive_skill_name_es.lsd.json');
const passiveSkillDescriptionDB = require('../rawdata/es/passive_skill_description_es.lsd.json');
