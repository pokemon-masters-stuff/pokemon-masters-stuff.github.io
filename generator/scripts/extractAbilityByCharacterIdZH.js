...
const abilityDescriptionDB = require('../rawdata/zh/AbilityDescription.json');
const moveDB = require('../rawdata/Move.json');
const moveNameDB = require('../rawdata/zh/MoveName.json');
const moveDescriptionDB = require('../rawdata/zh/MoveDescription.json');
const passiveAbilityDescriptionDB = require('../rawdata/zh/PassiveSkillName.json');
const passiveSkillDescriptionDB = require('../rawdata/zh/PassiveSkillDescription.json');
