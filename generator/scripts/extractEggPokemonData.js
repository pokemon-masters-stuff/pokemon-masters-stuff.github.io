...
const trainerNameDBde = require('../rawdata/lsddump/dl/trainer_name_de.json');
const trainerNameDBen = require('../rawdata/lsddump/dl/trainer_name_en.json');
const trainerNameDBes = require('../rawdata/lsddump/dl/trainer_name_es.json');
const trainerNameDBfr = require('../rawdata/lsddump/dl/trainer_name_fr.json');
const trainerNameDBit = require('../rawdata/lsddump/dl/trainer_name_it.json');
const trainerNameDBja = require('../rawdata/lsddump/dl/trainer_name_ja.json');
const trainerNameDBko = require('../rawdata/lsddump/dl/trainer_name_ko.json');
const trainerNameDBzh = require('../rawdata/lsddump/dl/trainer_name_zh-TW.json');
