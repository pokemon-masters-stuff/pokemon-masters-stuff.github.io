...
/*
 * Usage i.e: node extractAllSyncPairNamesAndIdsAndPrintOutNewSyncPairs.js
 * */

const extractAllSyncPairNamesAndIdsAndPrintOutNewSyncPairs = () => {
  let isNew = false;
  let isEggmon = false;
  let isBP = false;
...
extractAllSyncPairNamesAndIdsAndPrintOutNewSyncPairs();
