...
const abilityDescriptionDB = require('../rawdata/fr/ability_description_fr.lsd.json');
const moveDB = require('../rawdata/Move.json');
const moveNameDB = require('../rawdata/fr/move_name_fr.lsd.json');
const moveDescriptionDB = require('../rawdata/fr/move_description_fr.lsd.json');
const passiveAbilityDescriptionDB = require('../rawdata/fr/passive_skill_name_fr.lsd.json');
const passiveSkillDescriptionDB = require('../rawdata/fr/passive_skill_description_fr.lsd.json');
