...
const moveDescriptionDBde = require('../rawdata/lsddump/dl/move_description_de.json');
const moveDescriptionDBen = require('../rawdata/lsddump/dl/move_description_en.json');
const moveDescriptionDBes = require('../rawdata/lsddump/dl/move_description_es.json');
const moveDescriptionDBfr = require('../rawdata/lsddump/dl/move_description_fr.json');
const moveDescriptionDBit = require('../rawdata/lsddump/dl/move_description_it.json');
const moveDescriptionDBja = require('../rawdata/lsddump/dl/move_description_ja.json');
const moveDescriptionDBko = require('../rawdata/lsddump/dl/move_description_ko.json');
const moveDescriptionDBzh = require('../rawdata/lsddump/dl/move_description_zh-TW.json');

const moveDescriptionPartsDBde = require('../rawdata/lsddump/dl/move_description_parts_de.json');
const moveDescriptionPartsDBen = require('../rawdata/lsddump/dl/move_description_parts_en.json');
const moveDescriptionPartsDBes = require('../rawdata/lsddump/dl/move_description_parts_es.json');
const moveDescriptionPartsDBfr = require('../rawdata/lsddump/dl/move_description_parts_fr.json');
const moveDescriptionPartsDBit = require('../rawdata/lsddump/dl/move_description_parts_it.json');
const moveDescriptionPartsDBja = require('../rawdata/lsddump/dl/move_description_parts_ja.json');
const moveDescriptionPartsDBko = require('../rawdata/lsddump/dl/move_description_parts_ko.json');
const moveDescriptionPartsDBzh = require('../rawdata/lsddump/dl/move_description_parts_zh-TW.json');

const passiveSkillNameDBde = require('../rawdata/lsddump/dl/passive_skill_name_de.json');
const passiveSkillNameDBen = require('../rawdata/lsddump/dl/passive_skill_name_en.json');
const passiveSkillNameDBes = require('../rawdata/lsddump/dl/passive_skill_name_es.json');
const passiveSkillNameDBfr = require('../rawdata/lsddump/dl/passive_skill_name_fr.json');
const passiveSkillNameDBit = require('../rawdata/lsddump/dl/passive_skill_name_it.json');
const passiveSkillNameDBja = require('../rawdata/lsddump/dl/passive_skill_name_ja.json');
const passiveSkillNameDBko = require('../rawdata/lsddump/dl/passive_skill_name_ko.json');
const passiveSkillNameDBzh = require('../rawdata/lsddump/dl/passive_skill_name_zh-TW.json');

const passiveSkillNamePartsDBde = require('../rawdata/lsddump/dl/passive_skill_name_parts_de.json');
const passiveSkillNamePartsDBen = require('../rawdata/lsddump/dl/passive_skill_name_parts_en.json');
const passiveSkillNamePartsDBes = require('../rawdata/lsddump/dl/passive_skill_name_parts_es.json');
const passiveSkillNamePartsDBfr = require('../rawdata/lsddump/dl/passive_skill_name_parts_fr.json');
const passiveSkillNamePartsDBit = require('../rawdata/lsddump/dl/passive_skill_name_parts_it.json');
const passiveSkillNamePartsDBja = require('../rawdata/lsddump/dl/passive_skill_name_parts_ja.json');
const passiveSkillNamePartsDBko = require('../rawdata/lsddump/dl/passive_skill_name_parts_ko.json');
const passiveSkillNamePartsDBzh = require('../rawdata/lsddump/dl/passive_skill_name_parts_zh-TW.json');

const passiveSkillDescriptionDBde = require('../rawdata/lsddump/dl/passive_skill_description_de.json');
const passiveSkillDescriptionDBen = require('../rawdata/lsddump/dl/passive_skill_description_en.json');
const passiveSkillDescriptionDBes = require('../rawdata/lsddump/dl/passive_skill_description_es.json');
const passiveSkillDescriptionDBfr = require('../rawdata/lsddump/dl/passive_skill_description_fr.json');
const passiveSkillDescriptionDBit = require('../rawdata/lsddump/dl/passive_skill_description_it.json');
const passiveSkillDescriptionDBja = require('../rawdata/lsddump/dl/passive_skill_description_ja.json');
const passiveSkillDescriptionDBko = require('../rawdata/lsddump/dl/passive_skill_description_ko.json');
const passiveSkillDescriptionDBzh = require('../rawdata/lsddump/dl/passive_skill_description_zh-TW.json');

const passiveSkillDescriptionPartsDBde = require('../rawdata/lsddump/dl/passive_skill_description_parts_de.json');
const passiveSkillDescriptionPartsDBen = require('../rawdata/lsddump/dl/passive_skill_description_parts_en.json');
const passiveSkillDescriptionPartsDBes = require('../rawdata/lsddump/dl/passive_skill_description_parts_es.json');
const passiveSkillDescriptionPartsDBfr = require('../rawdata/lsddump/dl/passive_skill_description_parts_fr.json');
const passiveSkillDescriptionPartsDBit = require('../rawdata/lsddump/dl/passive_skill_description_parts_it.json');
const passiveSkillDescriptionPartsDBja = require('../rawdata/lsddump/dl/passive_skill_description_parts_ja.json');
const passiveSkillDescriptionPartsDBko = require('../rawdata/lsddump/dl/passive_skill_description_parts_ko.json');
const passiveSkillDescriptionPartsDBzh = require('../rawdata/lsddump/dl/passive_skill_description_parts_zh-TW.json');
