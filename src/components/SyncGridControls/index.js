...
function SyncGridControls(props) {
  ...
  const handleOnOpenSkillList = () => (typeof onOpenSkillListHandler === "function") ? onOpenSkillListHandler() : null;
  const handleOnChangePokemonHandler = (pokemon) => (typeof onChangePokemonHandler === "function") ? onChangePokemonHandler(pokemon) : null;
