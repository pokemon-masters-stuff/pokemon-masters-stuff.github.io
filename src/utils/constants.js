...
export const rolesByLanguage = {
  0: {
    de: 'Physischer Angreifer',
    en: 'Physical Strike',
    es: 'Ataque',
    fr: 'Attaquant Physique',
    it: 'Attaccante fisico',
    ja: '物理アタッカー',
    ko: '물리 어태커',
    zh: '物理攻擊型',
  },
  1: {
    de: 'Spezial-Angreifer',
    en: 'Special Strike',
    es: 'Ataque Especial',
    fr: 'Attaquant Spécial',
    it: 'Attaccante speciale',
    ja: '特殊アタッカー',
    ko: '특수 어태커',
    zh: '特殊攻擊型',
  },
