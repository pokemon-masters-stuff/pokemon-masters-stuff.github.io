export const SELECT_SYNC_PAIR = 'select_sync_pair';
...
export const CHANGE_POKEMON_FILTER = 'change_pokemon_filter';
export const CHANGE_SYNC_LEVEL_FILTER = 'change_sync_level_filter';
