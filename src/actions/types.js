...
export const ADD_TO_TEAM_GRID_LIST = 'add_to_grid_list';
export const REMOVE_FROM_TEAM_GRID_LIST = 'remove_from_grid_list';
// export const DISPLAY_GRID_DATA = 'display_grid_data';
// export const HIDE_GRID_DATA = 'hide_grid_data';
export const SUBTRACT_FROM_TEAM_REMAINING_ENERGY =
  'subtract_from_remaining_energy';
export const ADD_BACK_TO_TEAM_REMAINING_ENERGY = 'add_back_to_remaining_energy';
